$(document).ready(function() {
	...
	var $links = $('.scroll').find('a[href*=#]');	/* Searching links on navigation */	
	...
	$links.click(function(e) {	/* On a click */
		...
		var $target = $(this.hash),	      			/* The target element where the view should go */
			...
			scrollSpeed = 600;										/* The speed configurated (in miliseconds) in order to doing the scroll animation */
